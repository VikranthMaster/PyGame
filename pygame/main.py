...
# BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join('Assets','bulletsound.mp3'))
BULLET_FIRE_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'bulletsound.mp3'))
...
def red_handle_movement(keys_pressed, red):
    ...
    if keys_pressed[pygame.K_RIGHT] and red.x < WIDTH: #right
        red.x += VEL
    
    if keys_pressed[pygame.K_UP] and red.y - VEL > 0 and red.y + VEL + red.height < HEIGHT - 15: #up
        red.y -= VEL
